...
public class ResponseUtil {
    ...
    /**
     * Calculates the NTLMv2 Response for the given challenge, using the specified authentication target, username,
     * password, target information block, and client nonce.
     * 
     * @param target
    ...
    /**
     * Calculates the LMv2 Response for the given challenge, using the specified authentication target, username,
     ...
     *            The random 8-byte client nonce.
     * 
     * @return The NTLM2 Session Response. This is placed in the NTLM response field of the Type 3 message; the LM
     *         response field contains the client nonce, null-padded to 24 bytes.
     */
     ...
     *            The password.
     * 
     * @return The NTLM Hash of the given password, used in the calculation of the NTLM Response and the NTLMv2 and LMv2
     *         Hashes.
     */
    ...
    private static byte[] createBlob(byte[] targetInformation, byte[] clientNonce) {
        ...
        if (targetInformation==null) targetInformation= new byte[0];
